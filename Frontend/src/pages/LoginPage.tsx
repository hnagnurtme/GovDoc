...
export function LoginPage() {
  ...
  // We can write a custom style here or use existing Workspace/App stylesheet.
  // To avoid adding separate files, we can use inline styles or add classes to App.css or write clean styled blocks.
  // Since we have CSS variables in index.css, let's write a beautifully structured JSX with standard clean layout.
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        <div style={logoContainerStyle}>
          ...
          <h2 style={titleStyle}>GovDoc Intellisense</h2>
          <p style={subtitleStyle}>Legal Document Analysis & Retrieval Platform</p>
        </div>
        ...
        <div style={footerStyle}>
          <p>Don't have an account? <Link to="/register" style={linkStyle}>Create one</Link></p>
        </div>
      </div>
    </div>
  )
...
// Inline CSS for maximum flexibility and clean styling using custom palette
